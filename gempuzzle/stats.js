...
export const statsTimerCounter = createElement({ tag: 'div', eClass: 'stats-panel__timer-counter', parent: statsWrapper, inner: '00' });
export const statsTimerCounterSeconds = createElement({ tag: 'div', eClass: 'stats-panel__timer-counter_seconds', parent: statsWrapper, inner: '00' });